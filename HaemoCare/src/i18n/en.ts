const en = {
  ...
  'profileSetup.connectDoctor.noClinicians': 'No registered doctors at this hospital yet.',
  ...
  'symptoms.editLog': 'Edit Symptoms',
  'symptoms.saveChanges': 'Save Changes',
  'symptoms.deleteConfirmTitle': 'Delete this log?',
  'symptoms.deleteConfirmBody': 'This symptom log will be permanently removed. This cannot be undone.',
  'symptoms.deleteFailed': 'Could not delete this log. Please try again.',
  'symptoms.updateFailed': 'Could not save your changes. Please try again.',
  ...
  'clinician.detail.timeline.empty': 'No events in this window.',
  'clinician.detail.timeline.empty.urgentOnly': 'No urgent events in this window.',
  ...
  'clinician.detail.timeline.tx.hbDetail': 'pre {pre} → post {post} g/dL',
  'clinician.detail.timeline.log': 'Logged: {summary}',
  'clinician.detail.timeline.log.noSymptoms': 'Log without recorded symptoms',
  ...
  'clinician.detail.timeline.window.7d': '7 days',
  'clinician.detail.timeline.window.30d': '30 days',
  'clinician.detail.timeline.window.90d': '90 days',
  'clinician.detail.timeline.window.label': 'last {days} days',
  'clinician.detail.timeline.filter.urgentOnly': 'Urgent only',
  'clinician.detail.timeline.config.title': 'Timeline options',
  'clinician.detail.timeline.config.windowLabel': 'Time window',
  'clinician.detail.timeline.config.showNormals': 'Show normal-outcome logs',
  'clinician.detail.timeline.hiddenNormals': '{count} normal logs hidden — tap to show',
  'clinician.detail.timeline.summary.tx': 'transfusion',
  'clinician.detail.timeline.summary.appt': 'visit',
  'clinician.detail.timeline.summary.logs': '{count} log(s)',
  'clinician.detail.timeline.cal.today': 'Today',
  'clinician.detail.timeline.cal.weekday.sun': 'Sun',
  'clinician.detail.timeline.cal.weekday.mon': 'Mon',
  'clinician.detail.timeline.cal.weekday.tue': 'Tue',
  'clinician.detail.timeline.cal.weekday.wed': 'Wed',
  'clinician.detail.timeline.cal.weekday.thu': 'Thu',
  'clinician.detail.timeline.cal.weekday.fri': 'Fri',
  'clinician.detail.timeline.cal.weekday.sat': 'Sat',
  'clinician.detail.timeline.cal.day.empty': 'No events on this day.',
  'clinician.detail.timeline.cal.day.eventCount': '{count} event(s)',
  'clinician.detail.timeline.cal.hiddenNormalsMonth': '{count} normal logs hidden this month — tap to show',
  ...
  'admin.title': 'Admin',
  'admin.subtitle': 'Clinician approvals and the hospital directory',
  'admin.approvals.section': 'Pending clinicians',
  ...
  'admin.hospitals.section': 'Hospitals',
  'admin.hospitals.add': 'Add hospital',
  'admin.hospitals.addTitle': 'Add hospital',
  'admin.hospitals.editTitle': 'Edit hospital',
  'admin.hospitals.empty': 'No hospitals yet.',
  'admin.hospitals.inactive': 'INACTIVE',
  'admin.hospitals.edit': 'Edit',
  'admin.hospitals.deactivate': 'Deactivate',
  'admin.hospitals.reactivate': 'Reactivate',
  'admin.hospitals.nameTh': 'Name (Thai)',
  'admin.hospitals.nameEn': 'Name (English)',
  'admin.hospitals.code': 'Code (optional)',
  'admin.hospitals.region': 'Region',
  'admin.hospitals.regionNone': 'None',
  'admin.hospitals.region.north': 'North',
  'admin.hospitals.region.northeast': 'Northeast',
  'admin.hospitals.region.central': 'Central',
  'admin.hospitals.region.south': 'South',
  'admin.hospitals.region.east': 'East',
  'admin.hospitals.region.west': 'West',
  'admin.hospitals.nameRequiredTitle': 'Name required',
  'admin.hospitals.nameRequiredBody': 'Please fill in both the Thai and English hospital names.',
