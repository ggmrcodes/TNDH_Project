...
const th: Record<TranslationKey, string> = {
  ...
  'auth.forgotPassword.title': 'รีเซ็ตรหัสผ่าน',
  'auth.forgotPassword.subtitle': 'กรอกอีเมลของคุณ เราจะส่งลิงก์สำหรับตั้งรหัสผ่านใหม่ให้',
  'auth.forgotPassword.emailLabel': 'อีเมล',
  'auth.forgotPassword.submit': 'ส่งลิงก์รีเซ็ต',
  'auth.forgotPassword.backToLogin': '← กลับไปเข้าสู่ระบบ',
  'auth.forgotPassword.sent': 'ตรวจสอบอีเมลของคุณเพื่อใช้ลิงก์รีเซ็ตรหัสผ่าน หากไม่ได้รับภายในหนึ่งนาที กรุณาตรวจสอบในโฟลเดอร์สแปม',
  'auth.forgotPassword.error': 'ไม่สามารถส่งอีเมลรีเซ็ตได้ กรุณาลองอีกครั้ง',
  'auth.resetPassword.title': 'ตั้งรหัสผ่านใหม่',
  'auth.resetPassword.subtitle': 'เลือกรหัสผ่านที่คุณไม่เคยใช้มาก่อน',
  ...
  'auth.resetPassword.success': 'อัปเดตรหัสผ่านสำเร็จ คุณเข้าสู่ระบบเรียบร้อยแล้ว',
  'auth.resetPassword.error': 'ไม่สามารถอัปเดตรหัสผ่านได้ กรุณาลองอีกครั้ง',
  'auth.resetPassword.tooShort': 'รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร',
  ...
  'profileSetup.rhFactor': 'ปัจจัย Rh',
  ...
  'profileSetup.connectDoctor.noClinicians': 'ยังไม่มีแพทย์ที่ลงทะเบียนที่โรงพยาบาลนี้',
  ...
  'passport.bloodTypeLine': 'หมู่เลือด {type}  ·  Rh {sign}',
  'passport.rhPositive': 'บวก',
  'passport.rhNegative': 'ลบ',
  'passport.rhFactor': 'ปัจจัย Rh',
  ...
  'symptoms.editLog': 'แก้ไขอาการ',
  'symptoms.saveChanges': 'บันทึกการแก้ไข',
  'symptoms.deleteConfirmTitle': 'ลบบันทึกนี้?',
  'symptoms.deleteConfirmBody': 'บันทึกอาการนี้จะถูกลบอย่างถาวร ไม่สามารถกู้คืนได้',
  'symptoms.deleteFailed': 'ไม่สามารถลบบันทึกนี้ได้ กรุณาลองใหม่อีกครั้ง',
  'symptoms.updateFailed': 'ไม่สามารถบันทึกการแก้ไขได้ กรุณาลองใหม่อีกครั้ง',
  ...
  'medications.reminderTimeHint': 'เลือก {count} เวลาสำหรับ{label}',
  'medications.addCustomTime': 'เพิ่มเวลา',
  'medications.removeTime': 'ลบเวลา',
  'medications.daysOfWeek': 'วันที่ทาน',
  'medications.daysAllWeek': 'ทุกวัน',
  'medications.day.mon': 'จ',
  'medications.day.tue': 'อ',
  'medications.day.wed': 'พ',
  'medications.day.thu': 'พฤ',
  'medications.day.fri': 'ศ',
  'medications.day.sat': 'ส',
  'medications.day.sun': 'อา',
  'medications.mealTiming': 'เวลาทาน',
  'medications.mealTiming.beforeMeal': 'ก่อนอาหาร',
  'medications.mealTiming.withMeal': 'พร้อมอาหาร',
  'medications.mealTiming.afterMeal': 'หลังอาหาร',
  'medications.mealTiming.emptyStomach': 'ขณะท้องว่าง',
  'medications.mealTiming.clear': 'ล้าง',
  ...
  'importAppt.fhir.baseUrl': 'Base URL ของ FHIR',
  ...
  'importAppt.fhir.resourceId': 'รหัส FHIR',
  ...
  'clinician.linkPatient.cancel': 'ยกเลิก',
  'clinician.linkPatient.close': 'ปิด',
  'clinician.linkPatient.error.notFound': 'ไม่พบผู้ป่วย กรุณาตรวจสอบรหัสและลองอีกครั้ง',
  'clinician.linkPatient.error.alreadyActive': 'เชื่อมต่อกับผู้ป่วยรายนี้แล้ว',
  'clinician.linkPatient.error.alreadyPending': 'ส่งคำขอแล้ว — รอผู้ป่วยตอบรับ',
  'clinician.linkPatient.error.unknown': 'เกิดข้อผิดพลาด กรุณาลองอีกครั้ง',
  'clinician.linkPatient.success': 'ส่งคำขอแล้ว รอให้ผู้ป่วยอนุมัติ',
  'clinician.linkPatient.pendingRowSubtitle': 'รอผู้ป่วยตอบรับ',
  ...
  'patient.linkRequest.shareFullNameLabel': 'แบ่งปันชื่อ-นามสกุล',
  'patient.linkRequest.shareFullNameHelp': 'แพทย์จะเห็นชื่อ-นามสกุลของคุณในรายชื่อผู้ป่วย คุณเปลี่ยนการตั้งค่านี้ได้ที่การตั้งค่าความเป็นส่วนตัว',
  'patient.linkRequest.approve': 'อนุมัติ',
  'patient.linkRequest.decline': 'ปฏิเสธ',
  'patient.linkRequest.allDone': 'จัดการคำขอครบแล้ว',
  // Patient privacy — connected clinicians section (Thai polish in Phase 5)
  'privacy.connectedClinicians.title': 'แพทย์ที่เชื่อมต่อ',
  'privacy.connectedClinicians.empty': 'ยังไม่มีแพทย์ที่เชื่อมต่อ',
  'privacy.connectedClinicians.sharingFullName': 'แบ่งปันชื่อ-นามสกุล',
  'privacy.connectedClinicians.revoke': 'เพิกถอน',
  'privacy.connectedClinicians.revokeConfirmTitle': 'เพิกถอนการเข้าถึง?',
  'privacy.connectedClinicians.revokeConfirmBody': '{name} จะไม่เห็นบันทึก การรับเลือด หรือข้อมูลแนวโน้มของคุณอีกต่อไป',
  'privacy.connectedClinicians.revokeConfirmYes': 'เพิกถอน',
  'privacy.connectedClinicians.revokeConfirmNo': 'เก็บไว้',
  ...
  'clinician.detail.timeline.empty': 'ไม่มีเหตุการณ์ในช่วงนี้',
  'clinician.detail.timeline.empty.urgentOnly': 'ไม่มีเหตุการณ์ฉุกเฉินในช่วงนี้',
  ...
  'clinician.detail.timeline.tx.hbDetail': 'ก่อน {pre} → หลัง {post} g/dL',
  'clinician.detail.timeline.log': 'บันทึก: {summary}',
  'clinician.detail.timeline.log.noSymptoms': 'บันทึกไม่มีรายละเอียดอาการ',
  ...
  'clinician.detail.timeline.window.7d': '7 วัน',
  'clinician.detail.timeline.window.30d': '30 วัน',
  'clinician.detail.timeline.window.90d': '90 วัน',
  'clinician.detail.timeline.window.label': '{days} วันล่าสุด',
  'clinician.detail.timeline.filter.urgentOnly': 'เฉพาะฉุกเฉิน',
  'clinician.detail.timeline.config.title': 'ตัวเลือกการแสดงผล',
  'clinician.detail.timeline.config.windowLabel': 'ช่วงเวลา',
  'clinician.detail.timeline.config.showNormals': 'แสดงบันทึกผลปกติด้วย',
  'clinician.detail.timeline.hiddenNormals': 'ซ่อนบันทึกปกติไว้ {count} รายการ — แตะเพื่อแสดง',
  'clinician.detail.timeline.summary.tx': 'ถ่ายเลือด',
  'clinician.detail.timeline.summary.appt': 'นัด',
  'clinician.detail.timeline.summary.logs': '{count} บันทึก',
  'clinician.detail.timeline.cal.today': 'วันนี้',
  'clinician.detail.timeline.cal.weekday.sun': 'อา',
  'clinician.detail.timeline.cal.weekday.mon': 'จ',
  'clinician.detail.timeline.cal.weekday.tue': 'อ',
  'clinician.detail.timeline.cal.weekday.wed': 'พ',
  'clinician.detail.timeline.cal.weekday.thu': 'พฤ',
  'clinician.detail.timeline.cal.weekday.fri': 'ศ',
  'clinician.detail.timeline.cal.weekday.sat': 'ส',
  'clinician.detail.timeline.cal.day.empty': 'ไม่มีเหตุการณ์ในวันนี้',
  'clinician.detail.timeline.cal.day.eventCount': '{count} เหตุการณ์',
  'clinician.detail.timeline.cal.hiddenNormalsMonth': 'ซ่อนบันทึกปกติเดือนนี้ไว้ {count} รายการ — แตะเพื่อแสดง',
  ...
  'labTrends.sparkline.singlePoint': 'มีผลตรวจเพียง 1 ครั้ง — เพิ่มอีกครั้งเพื่อดูแนวโน้ม',
  'labTrends.sparkline.readings': '{count} ครั้ง',
  'labTrends.sparkline.dateRange': '{start} – {end}',
  'labTrends.trend.up': 'แนวโน้มเพิ่มขึ้น',
  'labTrends.trend.down': 'แนวโน้มลดลง',
  'labTrends.trend.flat': 'คงที่',
  ...
  'admin.subtitle': 'อนุมัติแพทย์และจัดการรายชื่อโรงพยาบาล',
  'admin.approvals.section': 'แพทย์รออนุมัติ',
  ...
  'admin.hospitals.section': 'โรงพยาบาล',
  'admin.hospitals.add': 'เพิ่มโรงพยาบาล',
  'admin.hospitals.addTitle': 'เพิ่มโรงพยาบาล',
  'admin.hospitals.editTitle': 'แก้ไขโรงพยาบาล',
  'admin.hospitals.empty': 'ยังไม่มีรายการ',
  'admin.hospitals.inactive': 'ปิดใช้งาน',
  'admin.hospitals.edit': 'แก้ไข',
  'admin.hospitals.deactivate': 'ปิดใช้งาน',
  'admin.hospitals.reactivate': 'เปิดใช้งาน',
  'admin.hospitals.nameTh': 'ชื่อ (ภาษาไทย)',
  'admin.hospitals.nameEn': 'ชื่อ (ภาษาอังกฤษ)',
  'admin.hospitals.code': 'รหัส (ไม่บังคับ)',
  'admin.hospitals.region': 'ภาค',
  'admin.hospitals.regionNone': 'ไม่ระบุ',
  'admin.hospitals.region.north': 'เหนือ',
  'admin.hospitals.region.northeast': 'ตะวันออกเฉียงเหนือ',
  'admin.hospitals.region.central': 'กลาง',
  'admin.hospitals.region.south': 'ใต้',
  'admin.hospitals.region.east': 'ตะวันออก',
  'admin.hospitals.region.west': 'ตะวันตก',
  'admin.hospitals.nameRequiredTitle': 'ต้องระบุชื่อ',
  'admin.hospitals.nameRequiredBody': 'กรุณาระบุชื่อโรงพยาบาลทั้งภาษาไทยและภาษาอังกฤษ',
